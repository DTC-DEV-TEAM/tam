...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload-employees') }}">
        ...
        <div class="box-body">
            ...
            <div class='callout callout-success'>
                ...
                * All records for uploading should have corresponding values/entries in all submasters.<br/>
                * System will not accept blank row.<br/>
           ...
           <label class='col-sm-2 control-label'>Import Template File: </label>
            <div class='col-sm-4'>
                <a href='{{ CRUDBooster::mainpath() }}/download-template-employee' class="btn btn-primary" role="button">Download Template</a>
            </div>
            <br/> 
            <br/>
