...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload-fulfillment') }}">
        ...
        <div class="row">
            ...
            <div class='col-sm-2'>
                <a href='{{ CRUDBooster::adminpath('admin_import') }}/download-filfill-qty-template' class="btn btn-primary" role="button">Download Template</a>
            </div>
            ...
            <div class='col-sm-3'>
                <select class="form-control select2" style="width: 100%;" required name="upload_type" id="upload_type">
                    ...
                    <option value="dr_rep">DR REP</option>
                    <option value="dr_ro">DR RO</option>
