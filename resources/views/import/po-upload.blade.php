...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload-po') }}">
        ...
        <div class="box-body">
            ...
            <div class='col-sm-2'>
                <a href='{{ CRUDBooster::adminpath('admin_import') }}/download-po-template' class="btn btn-primary" role="button">Download Template</a>
            </div>
