  ...
  <div class='panel panel-default'>
    ...
    <section id="loading">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">{{ trans('message.form-label.location_id') }}</label>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label"><span style="color:red">*</span>{{ trans('message.form-label.po_number') }}</label>
                ...
                <table id="asset-items">
                    <thead>
                        <tr>
                            ...
                            <th width="5%" class="text-center">{{ trans('message.form-label.location_id') }}</th>                                         
        ...
        @if(in_array(CRUDBooster::myPrivilegeId(),[1,6]))
            ...
            <button class="btn btn-success pull-right" type="submit" id="btnSubmit" style="margin-right:12px"> <i class="fa fa-check-circle"></i> {{ trans('message.form.submit') }}</button>
    ...
    var saveRemarks = $('#remarkscancel').val(remarks);
        if($('#po_no').val() === ""){
            ...
            swal({
                    ...
                    $.ajax({
                        url: "{{ route('assets.non.trade.get.nonTradeForPoProcess') }}",
                        dataType: "json",
                        type: "POST",
                        data: formData,
                        processData : false,
