        ...
        <div class='panel-body'>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label"><span style="color:red">*</span> {{ trans('message.form-label.location_id') }}</label>
                                    ...
                                    <table id="asset-items">
                                        <tbody id="bodyTable">
                                            <tr class="tbl_header_color dynamicRows">
                                                ...
                                                <th width="8%" class="text-center">{{ trans('message.table.category_id_text') }}</th>
                                                <th width="7%" class="text-center">{{ trans('message.table.sub_category_code') }}</th>
                                                ...
                                                <th width="3%" class="text-center">{{ trans('message.table.action') }}</th>
                                            </tr>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr id="tr-table1" class="bottom">
                                                <td colspan="4" class="text-center">
                                                    <span ><strong>{{ trans('message.table.total') }}</strong></span>
                                                </td>
                                                <td align="left">
...
@push('bottom')
    ...
    <script type="text/javascript">
        ...
        function addRow(e){
            var new_row = '<tr class="nr" id="rowid' + e.id + '" rows>' +
                ...
                '<td>' +
                    ...
                    '</select>' +
                '</td>' +
                '<td><input class="form-control text-center ginput text-center add_quantity" placeholder="Quantity" type="text" value="1" name="add_quantity[]" id="add_quantity' + e.id  + '" data-id="' + e.id  + '"  min="0" max="9999999999" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" oninput="validity.valid||(value=1);"></td>' +               
        ...
        $('.add_quantity').keydown(function(event) { 
            if (event.keyCode == 13) {
                event.preventDefault();
            }
        });
        $(document).on("keyup",".add_quantity, #amount, #value", function (e) {
                    ...
                    success: function (data) {
                        ...
                        //     }else{
                                swal({
                                    ...
                                    $.ajax({
                                        url: "{{ route('assets.non.trade.nonTradeApprovedProcess') }}",
                                        dataType: "json",
                                        type: "POST",
                                        data: formData,
                                        processData : false,
