...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('non-trade-upload-inventory') }}">
        ...
        <div class="box-body">
            ...
            <div class='col-sm-4'>
                <a href='{{ CRUDBooster::mainpath() }}/non-trade-upload-inventory-template' class="btn btn-primary" role="button">Download Template</a>
            </div>
            <br/>
            <br/>
