...
@endif
    ...
    <form method='post' id="myform" action='{{CRUDBooster::mainpath('edit-save/'.$Header->requestid)}}'>
        ...
        <input type="hidden" value="{{$Header->locking_close}}" name="locking" id="locking">
        ...
        @endif
            ...
            <div class="card">  
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <label class="control-label">On Boarding Date</i></label>
                            ...
                            <input type="text" class="form-control finput date" name="onboarding_date" id="onboarding_date" value="{{$Header->onboarding_date}}" aria-describedby="basic-addon1" readonly>             
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                @if($Header->locking_close === CRUDBooster::myId())
                <button class="btn btn-success pull-right" type="button" id="btnSet"> <i class="fa fa-times-circle" ></i> Close</button>
                @endif
            </div>
...
<script type="text/javascript">
    ...
    if($('#locking').val() === $('#current_user').val()){
        const pageHideListener = (event) => {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('delete-locking-close-request') }}",
                dataType: 'json',
                data: {
