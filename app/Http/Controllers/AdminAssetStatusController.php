<?php namespace App\Http\Controllers;
	...
	class AdminAssetStatusController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Status Type','name'=>'status_type','type'=>'select','validation'=>'required','width'=>'col-sm-5','dataenum'=>'ASSETS;INVENTORY;REQUEST'];
	        ...
	        */
			...
			$this->script_js = "
					$(document).ready(function() {
						$('#status_description').keyup(function() {
