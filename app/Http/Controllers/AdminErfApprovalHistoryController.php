<?php namespace App\Http\Controllers;
	...
	class AdminErfApprovalHistoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_query_index(&$query) {
			if(CRUDBooster::isSuperadmin()){
				...
				$query->whereNotNull('erf_header_request.approved_immediate_head_by')->where('erf_header_request.approved_immediate_head_by', CRUDBooster::myId())->whereNull('erf_header_request.deleted_at')->orderBy('erf_header_request.id', 'DESC');
			}
	    ...
	    */
		...
		public function getDetail($id){
			...
			$data['page_title'] = 'View Erf Approved History';
			...
			return $this->view("erf.approved_history", $data);
		}
	}