<?php namespace App\Http\Controllers;
	...
	class AdminConditionTypeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "id";
			$this->limit = "20";
			$this->orderby = "condition_description,asc";
			...
			$this->table = "condition_type";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Condition Description","name"=>"condition_description"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Condition Description','name'=>'condition_description','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Condition Description","name"=>"condition_description","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
