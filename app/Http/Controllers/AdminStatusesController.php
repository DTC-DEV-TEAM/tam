<?php namespace App\Http\Controllers;
	...
	class AdminStatusesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Status Name','name'=>'status_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Status','name'=>'status_type','type'=>'select','validation'=>'required','width'=>'col-sm-5','dataenum'=>'ASSETS;INVENTORY;REQUEST'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Status Name","name"=>"status_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
