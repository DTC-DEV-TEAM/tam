<?php namespace App\Http\Controllers;
	...
	class AdminStatusMatrixController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "status_matrices";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Current Step","name"=>"current_step"];
			$this->col[] = ["label"=>"Next Step","name"=>"next_step"];
			$this->col[] = ["label"=>"Request Type","name"=>"request_type","join"=>"requests,request_name"];
			$this->col[] = ["label"=>"User Type","name"=>"id_cms_privileges","join"=>"cms_privileges,name"];
			$this->col[] = ["label"=>"Status Workflow","name"=>"status_id","join"=>"statuses,status_description"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Current Step","name"=>"current_step","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Next Step","name"=>"next_step","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Request Type","name"=>"request_type","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
