<?php namespace App\Http\Controllers;
	...
	class AdminSubDepartmentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "sub_department_name";
			$this->limit = "20";
			...
			$this->col[] = ["label"=>"Sub Department Name","name"=>"sub_department_name"];
			...
			//$this->form[] = ["label"=>"Coa Id","name"=>"coa_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"coa,id"];
			//$this->form[] = ["label"=>"Sub Department Name","name"=>"sub_department_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
