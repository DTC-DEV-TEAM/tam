<?php namespace App\Http\Controllers;
	...
	class AdminSubMasterfileManpowerController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "sub_masterfile_manpower";
			...
			$this->col[] = ["label"=>"Updated At","name"=>"updated_at", "join" => "cms_users,name"];
