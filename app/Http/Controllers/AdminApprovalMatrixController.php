<?php namespace App\Http\Controllers;
	...
	class AdminApprovalMatrixController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Username','name'=>'cms_users_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-5','datatable'=>'cms_users,name','parent_select'=>'id_cms_privileges'];
			...
			//$this->form[] = ["label"=>"Department List","name"=>"department_list","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
			...
			$storeData = array();
			$storeList = json_encode($postdata['department_list'], true);
			...
			$postdata['department_list'] = implode(",", $storeData);
	    ...
	    */
		...
		public function getAddMatrix() {
			...
			$data['page_title'] = 'Create Approval Matrix';


			

			return $this->view("assets.add-matrix", $data);
