<?php namespace App\Http\Controllers;
	...
	class AdminVendorsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Status","name"=>"vendor_status"];
			...
			$this->form[] = ['label'=>'Vendor Name','name'=>'vendor_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];

			if(CRUDBooster::getCurrentMethod() == 'getEdit' || CRUDBooster::getCurrentMethod() == 'postEditSave' || CRUDBooster::getCurrentMethod() == 'getDetail') {
				$this->form[] = ['label'=>'Status','name'=>'vendor_status','type'=>'select','validation'=>'required','width'=>'col-sm-5','dataenum'=>'ACTIVE;INACTIVE'];
			}
			...
			//$this->form[] = ["label"=>"Vendor Type Id","name"=>"vendor_type_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"vendor_type,id"];
			//$this->form[] = ["label"=>"Vendor Status","name"=>"vendor_status","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Incoterms Id","name"=>"incoterms_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"incoterms,id"];
