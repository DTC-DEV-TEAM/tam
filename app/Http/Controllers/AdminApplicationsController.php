<?php namespace App\Http\Controllers;
	...
	class AdminApplicationsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"App Name","name"=>"app_name"];
			...
			$this->form[] = ['label'=>'App Name','name'=>'app_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"App Name","name"=>"app_name","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
